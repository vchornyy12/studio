      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">About AI Nexus</h2>
            <p className="text-lg text-muted-foreground">
              AI Nexus was founded with a mission to democratize access to powerful AI technologies. We believe in the transformative potential of AI and are dedicated to helping businesses of all sizes harness it for sustainable growth and innovation.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Delivering measurable impact and ROI for our clients.</p>
                </div>
              </div>
            </div>
